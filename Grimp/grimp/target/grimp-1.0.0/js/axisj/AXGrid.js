 ...
 * }
    ...
    saveEditor: function () {
        ...
        if (cfg.editor.request) {
            ...
            delete editorFormItem.check;
            delete editorFormItem.requestType;
            ...
            new AXReq(url, {
                ...
                onsucc: function (res) {
                    ...
                    if ((res.result && res.result == AXConfig.AXReq.okCode) || (res.result == undefined && !res.error)) {
                    	console.log("in if");
                        saveEditorRequest(res, editorFormItem);
     ...
     */
    saveEditorRequest: function (res, editorFormItem) {
        var cfg = this.config;

        console.log(res);
        console.log(editorFormItem);
        ...
        if (this.editorOpend) {
            ...
            if (cfg.editor.response) { 
            	console.log("next if");
            	/* 바뀌기 전에 editItem과 바뀐 이후의 editItem으로 교체 */
            	var thisList = this.list[this.editorItemIndex];
            	for(key in editorFormItem) {
            		thisList[key] =  editorFormItem[key];
            	}
